    ...
    <>
      ...
      <section className="px-6 md:px-16 py-16 md:py-24 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1">
          <span className="inline-block bg-coral-soft text-coral px-4 py-1.5 rounded-full text-sm font-bold mb-6">
        ...
        <div className="flex-1 flex justify-center">
          <div className="w-72 h-72 md:w-96 md:h-96 bg-gradient-to-br from-coral-soft to-amber-soft rounded-[40px] flex items-center justify-center relative overflow-hidden">
            <div className="absolute w-48 h-48 bg-white/40 rounded-full -top-8 -right-8" />
